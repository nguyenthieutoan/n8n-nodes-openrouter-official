...
export class OpenRouter implements INodeType {
	description: INodeTypeDescription = {
		...
		description: 'Consume OpenRouter API for multimodal analysis, image/video generation, STT and TTS',
		defaults: {
			name: 'OpenRouter',
		},
		inputs: ['main'],
				...
				options: [
					{
						...
						action: 'Analyze media with openrouter',
					},
					{
						name: 'Generate Image',
						value: 'generateImage',
						description: 'Generate an image from a text prompt',
						action: 'Generate an image with openrouter',
					},
					{
						name: 'Generate Video (Async)',
						value: 'generateVideo',
						description: 'Generate a video from a text prompt',
						action: 'Generate a video with openrouter',
					},
					{
						name: 'Speech To Text',
						value: 'speechToText',
						description: 'Transcribe audio into text',
						action: 'Transcribe audio with openrouter',
					},
					{
						name: 'Text To Speech',
						value: 'textToSpeech',
						description: 'Convert text into audio',
						action: 'Convert text to speech with openrouter',
					},
				],
				default: 'analyze',
			},
